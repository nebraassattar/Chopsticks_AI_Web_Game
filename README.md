...
Download or copy the complete chopsticks folder.

Keep all project files in the same folder.

Open index.html in a modern browser such as Chrome, Edge, or Firefox.

Choose Go first to play as Player A or Go second to play as Player B.
...
Every attack from an active current-player hand to an active opponent hand.

Every legal transfer of fingers from one current-player hand to the other.
